...
check_packages() {
  ...
  packages=("apt-utils" "git" "dnsutils" "net-tools" "nbtscan" "avahi-utils" "python3-requests" "python3-cpuinfo" "python3-cryptography" "libwww-perl" "mmdb-bin" "libtext-csv-perl" "aria2")
