...
install_additional_dependencies() {
  ...
  if $PYTHON3 ; then
    ...
    sudo apt-get install python3-pip python3-cryptography python3-requests python3-cpuinfo -y                 2>&1 >> "$LOG"
  else
    print_msg "- Installing Python 3..."
    sudo apt-get install python3 python3-pip python3-cryptography python3-requests python3-cpuinfo -y         2>&1 >> "$LOG"
  fi
